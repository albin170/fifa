  ...
  container.innerHTML = `
    ...
    <div class="grid-2 mb-lg">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button class="toggle-btn active" onclick="filterFacilities(this,'all')" aria-pressed="true">All</button>
            <button class="toggle-btn" onclick="filterFacilities(this,'mobility')" aria-pressed="false">Mobility</button>
            <button class="toggle-btn" onclick="filterFacilities(this,'sensory')" aria-pressed="false">Sensory</button>
          </div>
        </div>
    ...
    <div class="grid-2 mb-lg">
      ...
      <div class="card">
        ...
        <div class="tabs" role="tablist" aria-label="Accessibility service tabs">
          <button class="tab-btn active" onclick="switchAccessTab(this,'asl')" role="tab" aria-selected="true" aria-controls="tab-asl" id="tab-btn-asl">ASL Support</button>
          <button class="tab-btn" onclick="switchAccessTab(this,'audio-desc')" role="tab" aria-selected="false" aria-controls="tab-audio-desc" id="tab-btn-audio-desc">Audio Description</button>
          <button class="tab-btn" onclick="switchAccessTab(this,'live-caption')" role="tab" aria-selected="false" aria-controls="tab-live-caption" id="tab-btn-live-caption">Live Captions</button>
        </div>

        <div class="tab-panel active" id="tab-asl" role="tabpanel" aria-labelledby="tab-btn-asl">
        ...
        <div class="tab-panel" id="tab-audio-desc" role="tabpanel" aria-labelledby="tab-btn-audio-desc">
        ...
        <div class="tab-panel" id="tab-live-caption" role="tabpanel" aria-labelledby="tab-btn-live-caption">
